...
const Register = () => {
    ...
    const validatePassword = (_, value) => {
        ...
        if (!/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]{8,}$/.test(value)) {
            return Promise.reject("Password must be at least 8 characters, include an uppercase letter, a number, and a special character.");
        }
    ...
    return (
        <div className="form-container">
            ...
            <Form form={form} layout="vertical">
                <Row gutter={16}>
                    <Col span={12}>
                        <Form.Item label="First Name" name="firstName" rules={formRules.firstName}>
                            <Input placeholder="Enter your first name"/>
                        </Form.Item>
                    </Col>
                    <Col span={12}>
                        <Form.Item label="Last Name" name="lastName" rules={formRules.lastName}>
                ...
                <Row gutter={16}>
                    ...
                    <Col span={12}>
                        <Form.Item label="Phone Number" name="phone" rules={formRules.phone}>
                ...
                <Row gutter={16}>
                    <Col span={12}>
                        <Form.Item label="ID Type" name="idType" rules={[{ required: true, message: "Please select your ID type" }]}>
                    ...
                    <Col span={12}>
                        <Form.Item label="ID Number" name="idNumber" rules={formRules.idNumber}>
                ...
                <Row gutter={16}>
                    <Col span={12}>
                        <Form.Item label="Password" name="password" rules={formRules.password} hasFeedback>
                ...
                <div className="form-button-container">
                    <Button type="primary" className="form-button" onClick={handleSubmit} loading={isSubmitting}>
                        Register
                    </Button>
                </div>
            </Form>
